...
export const DONOR_FIELDS = [
  ...
  { key: "family_name", label: "Family / Household", type: "text", group: "affiliation" },
  ...
  { key: "yahrzeit_date", label: "Yahrzeit Date (loved one)", type: "text", group: "engagement" },
  { key: "yahrzeit_name", label: "Yahrzeit — In Memory Of", type: "text", group: "engagement" },
