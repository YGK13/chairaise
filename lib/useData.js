...
// On failure, throws an Error carrying the HTTP status and any machine-readable
// `code` (e.g. "donor_limit_reached") plus the raw body, so callers can react
// to specific conditions (like the plan cap) instead of treating all errors alike.
