...
// Email/password always works. OAuth buttons shown but gracefully
// handle the case where provider credentials aren't configured.
// ============================================================
...
function SignInPage() {
  ...
  const errorMessages = {
    ...
    Configuration: "OAuth provider not configured. Use email login instead.",
    OAuthCallback: "OAuth login failed. Please try email login.",
  ...
  const handleOAuth = async (provider) => {
    ...
    try {
      ...
      setError(`${provider} login not available. Use email login instead.`);
      setLoading("");
    }
  };
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {/* Email Login First — always works */}
        <form onSubmit={handleEmail}>
          <div style={{ marginBottom: 12 }}>
            ...
            <input
              ...
              placeholder="you@yourorg.org" autoFocus autoComplete="email"
              style={{
        ...
        <p style={{ fontSize: 11, color: "#52525b", textAlign: "center", marginTop: 12 }}>
          Any email + password (min 6 chars) creates an account automatically.
        </p>
