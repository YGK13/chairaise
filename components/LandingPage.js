...
export default function LandingPage() {
  ...
  return (
    <div style={{ background: "#09090b", color: "#fafafa", fontFamily: "'Inter', system-ui, sans-serif", minHeight: "100vh" }}>
      ...
      {/* Responsive + interaction polish (inline styles need !important to override) */}
      <style>{`
        .cr-feature-card { transition: border-color .2s ease, transform .2s ease; }
        .cr-feature-card:hover { border-color: #f59e0b !important; transform: translateY(-3px); }
        .cr-cta:hover { filter: brightness(1.06); }
        @media (max-width: 1100px) {
          .cr-grid3 { grid-template-columns: repeat(2, 1fr) !important; }
          .cr-grid4 { grid-template-columns: repeat(2, 1fr) !important; }
        }
        @media (max-width: 720px) {
          .cr-nav-link { display: none !important; }
          .cr-hero-h1 { font-size: 38px !important; letter-spacing: -1px !important; }
          .cr-hero-cta { flex-direction: column !important; align-items: stretch !important; }
          .cr-grid3, .cr-grid4, .cr-gridp { grid-template-columns: 1fr !important; }
        }
      `}</style>
      ...
      <nav style={{
        ...
        <div style={{ display: "flex", gap: 24, alignItems: "center" }}>
          <a className="cr-nav-link" href="#features" style={{ color: "#a1a1aa", fontSize: 13, fontWeight: 500, textDecoration: "none" }}>Features</a>
          <a className="cr-nav-link" href="#how" style={{ color: "#a1a1aa", fontSize: 13, fontWeight: 500, textDecoration: "none" }}>How It Works</a>
          <a className="cr-nav-link" href="#pricing" style={{ color: "#a1a1aa", fontSize: 13, fontWeight: 500, textDecoration: "none" }}>Pricing</a>
          <Link className="cr-nav-link" href="/auth/signin" style={{ color: "#a1a1aa", fontSize: 13, fontWeight: 500, textDecoration: "none" }}>Sign In</Link>
      ...
      <section style={{
        ...
        <div style={{ maxWidth: 800, margin: "0 auto", padding: "0 24px" }}>
          ...
          <div className="cr-hero-cta" style={{ display: "flex", gap: 12, justifyContent: "center" }}>
            <Link className="cr-cta" href="/auth/signin" style={{
      ...
      <section id="features" style={{ padding: "80px 24px", maxWidth: 1200, margin: "0 auto" }}>
        ...
        <div className="cr-grid3" style={{
          display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 16,
        }}>
          {FEATURES.map(f => (
            <div key={f.title} className="cr-feature-card" style={{
      ...
      <section id="how" style={{
        ...
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          <div className="cr-grid4" style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 24 }}>
            {[
      ...
      <section id="for-who" style={{
        ...
        <div style={{ maxWidth: 800, margin: "0 auto", textAlign: "center" }}>
          ...
          <div className="cr-grid4" style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 12 }}>
            {ORGS.map(o => (
      ...
      <section id="pricing" style={{ padding: "80px 24px", maxWidth: 1000, margin: "0 auto" }}>
        ...
        <div className="cr-gridp" style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 16 }}>
          {/* Free */}
          <div style={{
